...
function Login() {
  return (
    <div className='h-screen relative'>
        ...
        bg-gray-600  px-8 py-2 w-full max-w-md text-center '>
            <h1 className='text-left text-white font-bold mb-8 text-4xl'>Sign In</h1>
            <div className='space-y-4'>
                ...
                <div>
                    <button className='w-full bg-red-600 text-white py-3 rounded font-medium hover:bg-red-700 transition-colors'>Sign In</button>
                </div>
                <div>
                ...
                <div>
                    <p className='text-zinc-400'>New to Netflix?
                        <a href="#" className='text-white ml-1 hover:underline'>Sign up Now</a>
                    </p>
                </div>
